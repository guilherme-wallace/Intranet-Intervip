...
var EmailController = /** @class */ (function () {
    ...
    EmailController.prototype.enviarEmail = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, para, assunto, mensagem, transporter, mailOptions;
            return __generator(this, function (_b) {
                _a = req.body, para = _a.para, assunto = _a.assunto, mensagem = _a.mensagem;
