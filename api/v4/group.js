        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, node_fetch_1.default)('https://ixc.intervip.net.br/webservice/v1/cliente_condominio', options)
                            .then(function (response) { return response.json(); }).then(function (response) {
                            if (response.registros != undefined) {
                                var groups = [];
                                for (var _i = 0, _a = response.registros; _i < _a.length; _i++) {
                                    var group = _a[_i];
                                    groups.push({
                                        value: group.id,
