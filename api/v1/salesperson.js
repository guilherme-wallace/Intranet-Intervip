...
function getSalespeople(MySQL, queryString) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (queryString) {
                query = "SELECT * FROM saleSalesperson WHERE name LIKE ".concat((0, mysql_1.escape)("%".concat(queryString, "%")), ";");
            }
            else {
...
function getSalesperson(MySQL, salespersonId) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY;
        return __generator(this, function (_a) {
            QUERY = "SELECT * FROM saleSalesperson WHERE salespersonId = ".concat((0, mysql_1.escape)(salespersonId), ";");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(QUERY, function (error, response) {
                        if (error)
                            return reject(error);
