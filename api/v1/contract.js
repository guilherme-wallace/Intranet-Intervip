    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            if (status) {
                ...
                query = "SELECT Contratos.PacoteID as Pacote, Contratos.Cliente, group_concat(Contratos.Numero) as Planos,\n                PlanosPacotes.Descricao, Contratos.Assinatura, Contratos.Inicio, Contratos.Fim, Contratos.Situacao,\n                sum(Contratos.ValorPlano) as Valor, Contratos.Vendedor FROM isupergaus.Contratos\n                JOIN isupergaus.PlanosPacotes ON PlanosPacotes.Codigo = Contratos.Pacote\n                WHERE Contratos.Cliente = ".concat((0, mysql_1.escape)(clientId), " GROUP BY Contratos.PacoteID;");
            }
...
function getContract(MySQL, contractId) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY;
        return __generator(this, function (_a) {
            QUERY = "SELECT * FROM saleContract WHERE contractId = ".concat((0, mysql_1.escape)(contractId), ";");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(QUERY, function (error, response) {
                        if (error)
                            return reject(error);
...
function postContract(MySQL, contract) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY;
        return __generator(this, function (_a) {
            QUERY = "INSERT INTO saleContract (contractId, name, bandwidth, cost, startDate, endDate)\n        VALUES (".concat((0, mysql_1.escape)(contract.contractId), ", ").concat((0, mysql_1.escape)(contract.name), ", ").concat((0, mysql_1.escape)(contract.bandwidth), ",\n        ").concat((0, mysql_1.escape)(contract.cost), ", ").concat((0, mysql_1.escape)(contract.startDate), ", ").concat((0, mysql_1.escape)(contract.endDate), ");");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(QUERY, function (error, response) {
                        if (error)
                            return reject(error);
...
function updateContract(MySQL, contract) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY;
        return __generator(this, function (_a) {
            QUERY = "UPDATE saleContract SET startDate = ".concat((0, mysql_1.escape)(contract.startDate), ",\n        endDate = ").concat((0, mysql_1.escape)(contract.endDate), " WHERE contractId = ").concat((0, mysql_1.escape)(contract.contractId), ";");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(QUERY, function (error, response) {
                        if (error)
                            return reject(error);
