...
var condominio_1 = require("./condominio");
...
function getSales(MySQL, query) {
    return __awaiter(this, void 0, void 0, function () {
        var result, sales, _i, result_1, obj, salesperson, technology, contract, research, address, condominio, sale;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    address = _a.sent();
                    return [4 /*yield*/, (0, condominio_1.getCondominio)(MySQL, obj.condominioId)];
                case 8:
                    condominio = _a.sent();
