...
exports.getGroupAddress = exports.getPlans = exports.postGroup = exports.getGroup = exports.getGroups = void 0;
var MySQLErrors_1 = require("../../errors/MySQLErrors");
var database_1 = require("../database");
var mysql_1 = require("mysql");
function getGroups(MySQL, queryString) {
...
function getGroup(MySQL, groupId) {
    return __awaiter(this, void 0, void 0, function () {
        var query;
        return __generator(this, function (_a) {
            query = "SELECT * FROM `group` WHERE groupId = ".concat((0, mysql_1.escape)(groupId), ";");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(query, function (error, response) {
                        if (error)
                            return reject(error);
                        if (!response || response.length == 0) {
                            query = "SELECT Codigo as groupId, Nome as name FROM ClienteGrupo WHERE Codigo = ".concat((0, mysql_1.escape)(groupId), ";");
...
function postGroup(MySQL, group) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY;
        return __generator(this, function (_a) {
            QUERY = "INSERT INTO `group` (groupId, name) VALUES (".concat((0, mysql_1.escape)(group.groupId), ", ").concat((0, mysql_1.escape)(group.name), ");");
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    MySQL.query(QUERY, function (error, response) {
                        if (error)
                            return reject(error);
...
function getGroupAddress(MySQL, groupId) {
    return __awaiter(this, void 0, void 0, function () {
        var QUERY, result, QUERY_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    QUERY = "SELECT Clientes.CEP, Clientes.Endereco, Clientes.Numero, Clientes.Cidade, Clientes.Bairro,\n        count(*) AS Quantidade FROM isupergaus.Clientes WHERE Clientes.Grupo = ".concat((0, mysql_1.escape)(groupId), " GROUP BY Clientes.Endereco\n        ORDER BY Quantidade DESC LIMIT 1;");
