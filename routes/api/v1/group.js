...
GROUP.get('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                return [4 /*yield*/, api.v1.GetGroups((_b = (_a = req.query.query) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : null)];
            case 1:
                response = _c.sent();
...
GROUP.get('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, api.v1.GetGroup(+req.params.id)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.json(response)];
            case 2:
...
GROUP.post('/', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, api.v1.PostGroup(req.body)];
            case 1:
                response = _a.sent();
